...
for file in csv_files:
    ...
    # Find index where Gain (V/V) is closest to -1
    ...
    # --- Top plot: Gain (V/V) ---
    ax1.plot(x, dvout, label='Gain (V/V)', color='tab:orange', linewidth=2, linestyle='--')
    ...
    # --- Bottom plot: Vout (V) ---
    ax2.plot(x, vout, label='Vout (V)', color='tab:blue', linewidth=2)
